...
public class LightEffect : MonoBehaviour
{
    ...
    public class PulseSettings
    {
        ...
        [Space] [Range(0f, 3f)] public float Duration;
        public Color Color;

        [Space] [Range(0f, 3f)] public float IntensityAmplitude;

        [Range(0f, 3f)] public float RangeAmplitude;

        [Range(0f, 3f)] public float ColorWeight;
    }
    ...
    public class NoiseSettings
    {
        ...
        [Range(0f, 1f)] public float Intensity = 0.05f;
    ...
    [SerializeField] [Range(0f, 10f)] private float m_Range = 1f;
