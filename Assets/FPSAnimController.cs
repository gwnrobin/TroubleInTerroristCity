...
public class FPSAnimController : PlayerNetworkComponent
{
    private CoreAnimComponent fpsAnimator;
    private FPSCamera fpsCamera;
    private LookLayer internalLookLayer;
    protected RecoilAnimation recoilComponent;
    protected CharAnimData _charAnimData;

    private NetworkVariable<CharAnimData> charAnimData = new(default, NetworkVariableReadPermission.Everyone, NetworkVariableWritePermission.Owner);
    //private NetworkVariable<CharAnimStates> charAnimStates = new(default, NetworkVariableReadPermission.Everyone, NetworkVariableWritePermission.Owner);
    ...
    protected void InitAnimController()
    {
        ...
        _charAnimData = new CharAnimData();
    ...
    protected void UpdateAnimController()
    {
        ...
        _charAnimData.recoilAnim = new LocRot(recoilComponent.OutLoc, Quaternion.Euler(recoilComponent.OutRot));
        fpsAnimator.SetCharData(_charAnimData);
